...
```{r include=FALSE}
pdf(file = "~/Dropbox/Work/Manuscripts/Bioarchive_Morc3/output/Volcano_plot_Morc3_bioRxiv_RNAseq_genes.pdf")
Volcano_genes
Volcano_genes_labels
dev.off()
```
...
png(filename = "~/Dropbox/Work/Manuscripts/Bioarchive_Morc3/output/Volcano_plot_Morc3_bioRxiv_RNAseq_genes.png")
Volcano_genes
dev.off()
```
...
png(filename = "~/Dropbox/Work/Manuscripts/Bioarchive_Morc3/output/Volcano_plot_Morc3_bioRxiv_RNAseq_genes_label.png")
Volcano_genes_labels
dev.off()
...
pdf(file = "~/Dropbox/Work/Manuscripts/Bioarchive_Morc3/output/Volcano_plot_Morc3_bioRxiv_RNAseq_TE.pdf")
Volcano_TE
dev.off()
```

```{r save png TE volcano, include=FALSE}
png(file = "~/Dropbox/Work/Manuscripts/Bioarchive_Morc3/output/Volcano_plot_Morc3_bioRxiv_RNAseq_TE.png")
Volcano_TE
dev.off()
```
